    ...
    <section class="content card-body">
                            ...
                            <div class="col col-12 col-lg-6">
                                ...
                                <div class="table mt-3">
                                    <table class="">
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <a href="#" data-toggle="modal" data-target="#modal-edit-loteamento"
                                                    class="btn btn-info btn-block">Editar</a>

                                                {{-- Modal Editar Loteamento --}}
                                                <div class="modal fade" id="modal-edit-loteamento" style="display: none;"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form
                                                                action="{{ route('admin.loteamentos.update', ['loteamento' => $loteamento->id]) }}"
                                                                method="post">
                                                                @csrf
                                ...
                                <form
                                    ...
                                    <div class="table mt-3">
                                        <table>
                                            <tr>
                                                <td>Latitude:</td>
                                                <td><input id="txtLatitude" class="form-control" name="latitude"
                                                        step="0.000000000000001" type="number"
                                                        value="{{ $loteamento->coordenada ? $loteamento->coordenada->latitude : '' }}">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Longitude:</td>
                                                <td><input id="txtLongitude" class="form-control" name="longitude"
                                                        step="0.000000000000001" type="number"
                                                        value="{{ $loteamento->coordenada ? $loteamento->coordenada->longitude : '' }}">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">
                                                    <input id="txtZoom" name="zoom" type="text"
                                                        style="display: none">
                            ...
                            <div class="card-body">
                                <form id="updateLandingPage" method='POST'
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="w-100 h-50" name="descricao">{{ $loteamento->landingPage->descricao ?? '' }}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="descricao">Texto auxiliar para "Acompanhe a Obra"</label>
                                        <textarea class="w-100 h-50" name="texto_acompanhe_a_obra">{{ $loteamento->landingPage->texto_acompanhe_a_obra ?? '' }}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="descricao">Texto para "Localização"</label>
                                        <textarea class="w-100 h-50" name="endereco_completo">{{ $loteamento->landingPage->endereco_completo ?? '' }}</textarea>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="percentual_conclusao" min=0 max=100 step=0.01
                                            class="form-control"
                                            value="{{ $loteamento->landingPage->percentual_acompanhe_a_obra ?? 0 }}">
                                    </div>
                                    <div class="form-group">
                                        <button type="submit" id="updateLandingPage"
        ...
        <div class="row">
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Área crítica</h4>

                        <div class="section">
                            <button class="btn btn-danger" onclick="alert('todo: apagar dados')">Apagar todos os dados
                                desse loteamento</button>
                        </div>
                    </div>
                </div>
            </div>
...
@section('js')
    ...
    <script async
        src="https://maps.googleapis.com/maps/api/js?key={{ env('GCP_MAPS_API', '') }}&loading=async&callback=initMap&libraries=maps,marker">
    </script>
@endsection
